...
import com.bioinnovate.PreMediT.views.faq.FAQview;
...
public class Footer extends VerticalLayout {
    ...
    public Footer(Div div){
        ...
        if (vaadinSession.getAttribute("user") != null){
            ...
            myList.addClickListener(event -> UI.getCurrent().navigate(MyListView.class));
        }else {
        ...
        userGuid.addClickListener(event -> UI.getCurrent().navigate(UserGuideView.class));
        Span downloads = new Span();
        if (vaadinSession.getAttribute("user") != null){
            downloads.setText("Downloads");
            downloads.addClickListener(event -> UI.getCurrent().navigate(DownloadsView.class));
        }else {
            downloads.setText("Data Access");
            downloads.addClickListener(event -> UI.getCurrent().navigate(DataAccessView.class));
        }
        ...
        faq.addClickListener(event -> UI.getCurrent().navigate(FAQview.class));
        Span terms = new Span("Terms & Use Conditions");
        terms.addClickListener(event -> UI.getCurrent().navigate(DownloadsView.class));
        Span about = new Span("About Us");
        about.addClickListener(event -> UI.getCurrent().navigate(AboutUsView.class));
