package com.bioinnovate.Template.views.home;
...
import static com.bioinnovate.Template.views.home.NcbiApi.getJournals;
...
public class HomeView extends Div {
    ...
    public HomeView(){
        ...
        signUp.addClickListener(event -> getUI().get().navigate(LoginView.class));
